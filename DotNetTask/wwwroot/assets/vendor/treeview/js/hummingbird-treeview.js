(function ($) {
    ...
    $.fn.hummingbird.checkNode = function (tree, sel, vals) {
        ...
        if (sel == "text") {
            $.each(vals, function (i, e) {
                ...
                var the_node = tree.find('label:contains(' + e + ')').children('input:checkbox:not(:disabled)').prop("indeterminate", false).prop("checked", true).trigger("change");
                //no return needed
            ...
            $.each(vals, function (i, e) {
                ...
                var the_node = tree.find('input:checkbox:not(:disabled)[' + sel + '="' + e + '"]').prop("indeterminate", false).prop("checked", true).trigger("change");
                //no return needed
                $.fn.hummingbird.checkboxClicked(the_node);
            });
        }
    ...
    $.fn.hummingbird.uncheckNode = function (tree, sel, vals) {
        if (sel == "text") {
            $.each(vals, function (i, e) {
                var the_node = tree.find('label:contains(' + e + ')').children('input:checkbox:not(:disabled)').prop("indeterminate", false).prop("checked", false).trigger("change");
                $.fn.hummingbird.checkboxClicked(the_node);
            });
        } else {
            $.each(vals, function (i, e) {
                var the_node = tree.find('input:checkbox:not(:disabled)[' + sel + '="' + e + '"]').prop("indeterminate", false).prop("checked", false).trigger("change");
                $.fn.hummingbird.checkboxClicked(the_node);
            });
        }
        $.fn.hummingbird.triState(tree, false);
    ...
    $.fn.hummingbird.restoreState = function (tree, restore_state) {
        ...
        tree.find("input:checkbox").prop("checked", false).prop("indeterminate", false).trigger("change");
        ...
        if (jQuery.isEmptyObject(restore_state) == false) {
            if (jQuery.isEmptyObject(restore_state.checked) == false) {
                $.each(restore_state.checked, function (i, e) {
                    ...
                    tree.find("input:checkbox#" + e).prop("checked", true).trigger("change");
                });
            }
    ...
    $.fn.hummingbird.triState = function (tree, restrict) {
        ...
        $.each(the_uls, function (i, e) {
            ...
            if (checked_num_the_checkboxes == num_the_checkboxes) {
                ////console.log("case 1")
                $(this).parent('li').children('label').children('input:checkbox').prop('checked', true).prop('indeterminate', false).trigger("change");
            }
            if (checked_num_the_checkboxes < num_the_checkboxes && checked_num_the_checkboxes > 0) {
                ...
                //
                $(this).parent('li').children('label').children('input:checkbox').prop('checked', this_state).prop('indeterminate', true).trigger("change");
            }
            if (checked_num_the_checkboxes == 0) {
                ////console.log("case 3")
                $(this).parent('li').children('label').children('input:checkbox').prop('checked', false).prop('indeterminate', false).trigger("change");
            }
    ...
    $.fn.hummingbird.checkboxClicked = function (clickedNode) {
        ...
        if (true) {
            ...
            if (clickedNode.hasClass("hummingbird-end-node") == false) {
                ////console.log("parent")
                ////console.log(this_state)
                clickedNode.parent("label").siblings("ul").find("input:checkbox:not(:disabled)").prop("checked", this_state).prop("indeterminate", false).trigger("change");
